...
4. ضع رقم LAN Port داخل Settings في Frinedo.
5. ضع Host، وغالبًا يكون `127.0.0.1` على نفس الكمبيوتر.
6. ضع اسم البوت الأساسي، ويمكنك تحديد Bot 2 أو Bot 3 أو Bot 4.
7. احفظ Settings ثم اضغط Connect.
